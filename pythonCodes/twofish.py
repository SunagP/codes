block_size = 16 #16*8=128 bits
key_size = 32 #32*8=256 bits
...
#x="\x90\xAF\xE9\x1B\xB2\x88\x54\x4F\x2C\x32\xDC\x23\x9B\x26\x35\xE6"
#__testdat = x
...
__testdat=ans
print "\nPlain Text : "+ans
cipher=str(Twofish(__testkey).encrypt(__testdat)) 
#cipher=cipher+cipher
print "\nCipher Text\n--------\n"+cipher+"\n--------"
dcrypt=Twofish(__testkey).decrypt(cipher)
print "\nDecrypted : "+dcrypt
ans=""
lis= dcrypt.split('\\x')
for i in lis:
